      ...
      {kind === "phone" ? (
        <div className="flex rounded-md shadow-sm">
          ...
          <input
            ...
            {...register}
            type={type}
            className="w-full appearance-none rounded-md rounded-l-none border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-green-600 focus:outline-none focus:ring-green-600"
          />
        </div>
      ) : null}
    </div>

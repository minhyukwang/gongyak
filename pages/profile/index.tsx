      ...
      <div className="px-6 pt-2">
        <div className="mt-4 flex items-center space-x-6">
          ...
          <div className="flex flex-col">
            <span className="text-2xl font-bold text-slate-800">세윤</span>
        ...
        <div className="mt-6 flex justify-around">
          <Link href="/list">
            <a className="flex flex-col items-center">
              ...
              <div className="flex h-14 w-14 items-center justify-center text-slate-700 hover:border-slate-900 hover:text-slate-900">
          ...
          <div>
            ...
            <div className="flex w-24 justify-start overflow-x-scroll scrollbar-hide">
              <Link href="/profile/sold">
                <a className="flex flex-col items-center">
                  <div className="w-50 flex h-14 space-x-1 overflow-x-auto">
                    <svg
                      className="h-8 w-8"
                      fill="currentColor"
                      viewBox="0 0 20 20"
        ...
        <div className="mt-6 -ml-20 flex justify-around">
